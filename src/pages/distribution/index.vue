...
png" />
                ...
                <el-table-column label="推广用户数量" prop="share_num" align="center" width="110px"></el-table-column>
                <el-table-column label="订单数量" prop="share_order_num" align="center" width="90px"></el-table-column>
                <el-table-column label="订单金额" prop="order_price" align="center" width="90px"></el-table-column>
                <el-table-column label="账户佣金" prop="commission" align="center" width="90px"></el-table-column>
                <el-table-column label="以提现金额" prop="cash_out_price" align="center" width="100px"></el-table-column>
                <el-table-column label="提现次数" prop="cash_out_time" align="center" width="90px"></el-table-column>
                <el-table-column label="未提现金额" prop="no_cash_out_price" align="center" width="90px"></el-table-column>
