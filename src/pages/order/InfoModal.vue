<template>
    <el-drawer title="订单详情" v-model="dialogVisible" size="50%" :destroy-on-close="true" :show-close="true"
        ...
        <el-card shadow="never" class="mb-3" v-if="info.ship_data">
            ...
            <el-form label-width="80px">
                ...
                <el-form-item label="运单号">
                    ...
                    <el-button type="primary" text size="small" @click="openShipInfoModal(info.id)" :loading="loading"
                        class="ml-3">查看物流</el-button>
        ...
        <el-card shadow="never" class="mb-3">
            ...
            <el-form label-width="80px">
                <el-form-item label="成交价">
                    <span class="text-red-500 font-bold">¥{{ info.total_price }}</span>
                </el-form-item>
            </el-form>
