            ...
            <el-tabs v-model="activeName">
                ...
                <el-tab-pane label="上传设置" name="second">
                    ...
                    <el-form-item label="空间域名">
                        ...
                        <sma11 class="text-gray-500 f1ex mt-1">请补全http://或https://</sma11>
                    </el-form-item>
                </el-tab-pane>
                <el-tab-pane label="Api安全" name="third">
                    <el-form-item label="是否开启API安全">
                        ...
                        <small class="text-gray-500 f1ex mt-1">api安全功能开启之后调用前端api需要传输签
                            名串</small>
                    </el-form-item>
                    <el-form-item label="秘钥">
                        <el-input v-model="form.api_secret" placeholder="" style="width:30%;"></el-input>
                        <small class="text-gray-500 f1ex mt-1">秘钥设置关系系统中api调用传输签名串的编
                            规则，以及会员token解析，请慎重设置，注意设置之后对应会员要求重新登录获取token </small>
                    </el-form-item>
                </el-tab-pane>
            </el-tabs>
            <el-form-item>
